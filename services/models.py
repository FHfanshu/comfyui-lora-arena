...
class Checkpoint(Base):
    ...
    training_data_path = Column(String(1024), nullable=True)
    ...
    # Relationships
    battles_as_left = relationship(
        "Battle",
        foreign_keys="Battle.left_checkpoint_id",
        back_populates="left_checkpoint",
    )
    battles_as_right = relationship(
        "Battle",
        foreign_keys="Battle.right_checkpoint_id",
        back_populates="right_checkpoint",
    )
...
class Battle(Base):
    ...
    # Generated images (ComfyUI output paths)
    ...
    # Relationships
    left_checkpoint = relationship(
        "Checkpoint",
        foreign_keys=[left_checkpoint_id],
        back_populates="battles_as_left",
    )
    right_checkpoint = relationship(
        "Checkpoint",
        foreign_keys=[right_checkpoint_id],
        back_populates="battles_as_right",
    )
